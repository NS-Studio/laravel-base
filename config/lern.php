...
return [
    ...
    'notify' => [
         ...
         */
        'mail'                       => [
            'to'   => 'ninicstefan94@gmail.com',
            'from' => 'rental_lern@rental.com',
            'smtp' => true,
        ],
        ...
        'slack'                      => [
            ...
            'channel'  => env( 'SLACK_CHANNEL', '#general' ), //Dont forget the '#'
            'username' => env( 'SLACK_USERNAME', 'Laravel Base - SPA' ), //The 'from' name
        ],
