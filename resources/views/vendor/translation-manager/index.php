                  ...
                  if ( n.fire( r, 'ajax:before' ) ) {
                      ...
                      c = {
                          type:           i || 'GET', data: o, dataType: l, beforeSend: function ( e, i ) {
                              ...
                              r.trigger( 'ajax:success', [
                                  e,
                                  t,
                                  n
                              ] );
                          }, complete:    function ( e, t ) {
                              r.trigger( 'ajax:complete', [
                                  e,
                                  t
                              ] );
                          }, error:       function ( e, t, n ) {
                              r.trigger( 'ajax:error', [
                                  e,
                                  t,
                                  n
                              ] );
...
<div class="container-fluid">
  <p>Warning, translations are not visible until they are exported back to the app/lang file, using <code>php artisan
                                                                                                          translation:export</code>
     command or publish button.</p>
  <div class="alert alert-success success-import"
       style="display:none;">
    <p>Done importing, processed <strong class="counter">N</strong> items! Reload this page to refresh the groups!
    </p>
  </div>
  <div class="alert alert-success success-find"
       style="display:none;">
  ...
  <div class="alert alert-success success-publish-all"
       style="display:none;">
...
<?php endif; ?>
    <?php if ( isset( $group ) ) : ?>
      <form class="form-inline form-publish"
            method="POST"
  ...
  <form role="form"
      ...
      <select name="group"
          ...
          <?php foreach ( $groups as $key => $value ): ?>
            <option value="<?php echo $key ?>"<?php echo $key ==
                                                         $group ? ' selected' : '' ?>><?php echo $value ?></option>
          <?php endforeach; ?>
      </select>
    </div>
    <div class="form-group">
    ...
    <?php if ( $group ): ?>
      <form action="<?php echo action( '\Barryvdh\TranslationManager\Controller@postAdd', [ $group ] ) ?>"
            method="POST"
            role="form">
        <input type="hidden"
               name="_token"
    ...
    <?php else: ?>
      ...
      <fieldset>
        ...
        <form class="form-inline form-publish-all"
              method="POST"
